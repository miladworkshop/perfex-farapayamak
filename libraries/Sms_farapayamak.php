...
class Sms_farapayamak extends App_sms
{
    ...
    public function __construct()
    {
        ...
        $this->add_gateway('farapayamak', [
            'name'    => 'فرا پیامک',
            'info'    => "<p>ارسال کلیه پیامک‌های سیستم از طریق سامانه پیامکی <a href='https://farapayamak.ir' target='_blank'>فرا پیامک</a> - طراحی و توسطعه داده شده توسط <a href='https://miladworkshop.ir' target='_blank'>میلاد مالدار</a></p><hr class='hr-10'>",
            'options' => [
                [
                    'name'  => 'from',
                    'label' => 'شماره فرستنده',
